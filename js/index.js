...
SiriWave.prototype = {
	_globalAttenuationFn: function(x){
		return Math.pow(this.K*4/(this.K*4+Math.pow(x,4)),this.K*1);
	},
	...
	_draw: function(){
		...
		this.phase = (this.phase+this.speed)%(Math.PI*640);
		this._clear();
		this._drawLine(-2, 'rgba(17,92,167,0.2)', 1);
		this._drawLine(-4, 'rgba(17,92,167,0.3)', 2);
		this._drawLine(-6, 'rgba(17,92,167,0.4)', 3);
		this._drawLine(6, 'rgba(17,92,167,0.5)', 4);
		this._drawLine(4, 'rgba(17,92,167,0.6)', 5);
		this._drawLine(2, 'rgba(17,92,167,0.8)', 6);
		this._drawLine(1, 'rgba(17,92,167,1)', 7);
